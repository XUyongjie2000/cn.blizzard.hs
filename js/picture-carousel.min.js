    ...
    generateHorizontalCarousel: function (containerWidth, containerHeight) {
      ...
      if (this.options.arrow) {
        var leftBtn = this.parseElement(
          '<div class="horizontal-carousel-arrow-left" style="display: none;"></div>'
        );
        var rightBtn = this.parseElement(
          '<div class="horizontal-carousel-arrow-right" style="display: none;"></div>'
        );
...
var box = new PictureCarousel("#box", {
  ...
  listData: [
    //插入图片等的数据
    { src: "./images/t1.png", alt: "1" },
    { src: "./images/t2.png", alt: "2" },
    { src: "./images/t2.png", alt: "3" },
  ],
});
box.init();
